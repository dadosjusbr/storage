...
// NewClient NewClient
func NewClient(db IDatabase, cloud IStorageService) (*Client, error) {
...
func (c *Client) Close(db IDatabase, cloud IStorageService) error {
	return c.Db.Disconnect()
}

// GetOPE Connect to db to collect data to build 'Órgao por estado' screen
func (c *Client) GetOPE(Uf string, Year int) ([]Orgao, map[string][]Coleta, error) {
...
func (c *Client) GetOMA(month int, year int, agency string) (*Coleta, *Orgao, error) {
...
func (c *Client) Store(agmi Coleta) error {
